...
.login-panel-container {
  ...
  max-width: 24rem;
  height: 550px;
  border-radius: 0.75rem; /* samain Tailwind rounded-xl */
  overflow: hidden;
}
...
.glass-field::after{
  ...
  backdrop-filter: blur(1px) brightness(1.4) url(#displacementFilterRev);
  -webkit-backdrop-filter: blur(8px) brightness(1);
  z-index:2;
  border-radius: 9999px;
}
...
<body class="h-screen w-screen bg-[url('/assets/image2.jpg')] bg-cover bg-center relative font-sans">
            ...
            <div class="login-panel-content w-full max-w-sm h-[550px] p-10 rounded-xl text-white border-[0.1pt] border-gray-400/50">
                ...
                <form method="POST" action="{{ route('login.submit') }}" class="space-y-4">
                    ...
                    <div class="glass-field border-[0.1pt] border-gray-400/50">
                    <input name="email" type="email" value="{{ old('email') }}"
                        class="glass-input" placeholder="Masukkan email" required autofocus>
                    </div>

                    <!-- Password -->
                    <label class="block mb-2 text-sm font-semibold">Kata Sandi</label>
                    <div class="glass-field border-[0.1pt] border-gray-400/50">
                    <input id="passwordInput" type="password" name="password" class="glass-input" placeholder="Masukkan kata sandi">
